...
Scroll Press is an HTML-native preprint archive for research authored by humans.
Part of [Aris: the open research stack](https://aris.pub). Built with FastAPI, it
accepts output from any authoring tool that produces HTML—Typst, Quarto, MyST,
Jupyter, or handwritten HTML. Format freedom, instant publication, permanent URLs.
